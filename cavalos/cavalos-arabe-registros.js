...
const { createPropriedadeCavaloRecord, updateStatusColeta } = require('../services/cavalos-services');
...
exports.runRobo = async () => {
    ...
    try {
        ...
        // TODO preciso saber qual é qual
        // atualiza no banco quando terminou a coleta
        await updateStatusColeta(SIGLA)
